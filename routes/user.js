...
router.post('/register', function (req, res) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
        user: 'vrunprajapati1996@gmail.com', // generated ethereal user
        pass: '123varun'  // generated ethereal password
    },
    tls:{
  ...
  let mailOptions = {
      from: '"Nodemailer Contact" <vrunprajapati1996@gmail.com>', // sender address
      to: 'vrunprajapati1996@gmail.com', // list of receivers
